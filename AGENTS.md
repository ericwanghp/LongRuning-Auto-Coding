...
> Multi-role collaborative development framework based on Codex native Agent Teams + Anthropic's best practices for long-running agents.
...
```
1. Update tasks metadata
2. Record progress log
3. Commit atomically
```
